...
# ============================================================
# ANA ARAYÜZ (STREAMLIT) - VERİ KAYNAĞI SEÇİMİ
# ============================================================
...
with col_upload:
    ...
    if uploaded_file is not None:
        try:
            # ÇÖZÜM: Streamlit UploadedFile nesnesini io.BytesIO ile sarmalıyoruz.
...
# Eğer manuel giriş yapıldıysa öncelik ona verilir
if manuel_req_codes:
    req_codes = manuel_req_codes
    # Manuel giriş için sanal bir Excel (wb) oluşturuyoruz (Raporlama çıktısı için gereklidir)
